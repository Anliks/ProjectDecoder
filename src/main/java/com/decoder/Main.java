...
import com.decoder.service.ServiceDecoder;

public class Main {

    public static int shiftPosition = 1;

    public static String cipherText = "Еъёчхф Вхзёюлх, адздёиу ф ждэщхб, црбх еёдюэчъщъгюъв южаижжзчх, ждчъёнъгжзчдв. Ъы зёюивй жёхчгюв бюнс ж ъы вдгивъгзхбсгрв аёхкдв. \n" +
    ...
    public static void main(String[] args) {
        ...
        ServiceDecoder decoder = new ServiceDecoder();

        while (shiftPosition < 34) {
         decoder.decoderCaesar();
         shiftPosition++;
        }
